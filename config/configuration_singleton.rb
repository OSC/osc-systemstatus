...
# App specific configuration singleton definition
#
...
class ConfigurationSingleton
  ...
  def config_root
    Pathname.new(ENV["OOD_APP_CONFIG_ROOT"] || "/etc/ood/config/apps/systemstatus")
  end
  ...
  def dataroot
    ...
    if rails_env == "production"
      root ||= "~/#{ENV['OOD_PORTAL'] || 'ondemand'}/data/#{ENV['APP_TOKEN'] || 'sys/systemstatus'}"
    else
